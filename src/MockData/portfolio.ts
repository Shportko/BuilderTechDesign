...
export const projects: TContentItem[] = [ 
    ...
    subItems: [
      ...
      },
      {
        ...
        description: [
          ...
          "Total area - 200 ft",
          "Residential 2-room apartment",
          "Style - neoclassical.",
          "Light shades that harmonize perfectly with the emerald wall and terracotta furniture. Also metal and glass, which are an integral part of neoclassicism.",
        ],
      },
    ],
  },
  {
    ...
    alt: "Builder Tech Design Barnhouse T3",
    anchorId: "project-item2",
    metaTitle: "Barnhouse T3 project in Texas | Builder Tech Design",
    metaDescription:
    ...
    subItems: [
      ...
      },
      {
        ...
        description: [
          "Barnhouse T3",
          "Total area - 300 ft.",
          "The object of construction is a 1-storey half-timbered residential building.",
          "It has 2 living rooms, a bathroom, a boiler room, a terrace and",
          "kitchen-living room. The owner's vehicles will be parked on the site.",
          "The property has a swimming pool and grill area.",
        ]
      },
    ],
  },
  {
    ...
    metaTitle: "Vacation home in Texas | Builder Tech Design",
    metaDescription:
    ...
    subItems: [
      ...
      },
      {
        ...
        description:[
          ...
          "- dressing room in each bedroom;",
          "- guest bathroom;",
          "- spacious kitchen;",
          "- large dining room;",
          "- living room for a large family;",
    ...
    subItems: [
      ...
      },
      {
        ...
        description:[
          "Apartment design project",
          "Total area - 148ft.",
          "Residential 1-room apartment",
          "Style - minimalism",
          "Light shades, black inserts and a lot of light. All this makes the room visually more spacious.",]
      },
    ],
  },
  {
    ...
    subItems: [
      ...
      },
      {
        ...
        description:[
          ...
          "Total area - 12385 ft",
          "The object of construction is a 3-storey children's shopping center.",
          "The territory of the site around the shopping center is being improved. Vehicles will be parked in the designed car park located on the site.",]
      },
    ],
  },
  {
